...
const Receive = () => {
  ...
  if (state === "transfering") {
    let intvalId = setInterval(() => {
      setReceivedPercentage(Math.floor((sizeReceived.current / fileSize.current) * 100));
      setCircleStroke((sizeReceived.current / fileSize.current) * 615.752);
      if (sizeReceived.current === fileSize.current && filesReceived.current === files.length) {
    ...
    pc2.ondatachannel = (event) => {
      ...
      receiveChannel.onmessage = (event) => {
        ...
        if (typeof event.data === "object") {
          ...
          if (fileSize.current !== 0 && sizeReceived.current !== 0 && fileSize.current === sizeReceived.current) {
  ...
  useEffect(() => {
    if (id && state === "loading") {
      ...
      socket.addEventListener("open", () => {
        socket.send(JSON.stringify({ event: "CONNECTION_REQUEST", destination: id }));
      });
    ...
    <div className="page-receiver">
      <div className="content-top">
        <div className="left">
          ...
          <div className="container-modal">
            <div className="transfer-receiver">
              <i className="bi bi-x-lg icon-close" onClick={() => navigate(`${id ? "/receive" : "/"}`)}></i>
              {state === "loading" && (
              ...
              {state === "failed" && (
                <div className="transfer-receiver-inner-failed">
                  ...
                  <p>
                    The sender has either closed this transfer or is now offline. Please check if the sender has an
                    active internet connection or ask for a new link.
                  </p>
                </div>
              )}
              {state === "enterCode" && (
                <div className="transfer-receiver-inner Share-code">
                  ...
                  <p>Enter the share code you received from the sender to start a secure transfer.</p>
                  ...
                  <div className="spacer"></div>
                  <div className="button on-white" onClick={() => navigate(`/receive/${tempCode}`)}>
                    Submit
                  </div>
                </div>
              )}
                  ...
                  <div className="container-files">
                    {files?.map((file) => (
                      <div className="item-file">
                        ...
                        <span className="filesize">{sizeConverter(file.size)}</span>
                      </div>
                    ))}
                  </div>
                  <div className="spacer"></div>
                ...
                <div className="container-progress">
                  <div className="container-progress-circle">
                    <svg viewBox="0 0 200 200" className="progress-ring">
                      ...
                      ></circle>
                      <text fill="#fff" fontSize="32" x="50%" y="45%" dominantBaseline="middle" textAnchor="middle">
        ...
        <div className="right">
          <div className="right-centered">
            <h1>Receiving files with ShareNova</h1>
            {state !== "enterCode" ? (
              <p>
                You are about to start a secure transfer with ShareNova, directly from the sender. Click download to
                start receiving the file(s).
              </p>
            ) : (
              <p>
                You are one step away from downloading your file(s). Enter Share Code received from sender and submit to
                open download page.
              </p>
            )}
          </div>
      ...
      <div className="content-bottom">
        <div className="container-informative">
          ...
          <p className="italic">
            In order to use ShareNova to its fullest potential we would like to give you some tips and tricks. These are
            based on suggestions and questions we received over the last couple of years.
          </p>
          <div className="item-info">
            ...
            <div className="block-info">
              ...
              <p>
                With Firefox, Chrome and Edge we can store the files directly to your disk. With other browsers the
                files may first simply be put in your computers memory. This is fine for smaller files, but with large
                files (1GB and up) this may result in unexpected behaviour.
              </p>
            </div>
          </div>
          <div className="item-info">
            ...
            <div className="block-info">
              <h3>On mobile devices, keep this page open until the transfer is complete</h3>
              <p>
                On desktop devices (Windows, MacOS, Linux etc.) you can simply minimize this browser tab, but doing the
                same thing on a mobile device can result in Android or iOS putting the website to sleep.
              </p>
            </div>
          </div>
          <div className="item-info">
            ...
            <div className="block-info">
              ...
              <p>
                The biggest mistake when using ShareNova is if the sender decides to close the website or turns off the
                device. Peer to peer only works if both sender and receiver are online at the same time.
              </p>
            </div>
          </div>
          <div className="item-info">
            ...
            <div className="block-info">
              ...
              <p>
                We currently do not support sending folders. Instead you can put all of your files in an archive or zip
                file . This allows you to transfer complete folder structures and will even save on bandwidth.
              </p>
            </div>
          </div>
          <div className="item-info">
            ...
            <div className="block-info">
              ...
              <p>
                We always try to find the most optimal connection, but sometimes we simply fail. If you experience much
                lower transfer speed than you would expect it might help to simply restart the transfer.
              </p>
            </div>
          </div>
          <div className="item-info">
            ...
            <div className="block-info">
              ...
              <p>
                If you're on a metered connection make sure you don't make any unexpected costs because of high data
                usage. What some people don't know is that uploading may also count towards the total amount of data
                used.
              </p>
            </div>
          </div>
          <div className="item-info">
            ...
            <div className="block-info">
              ...
              <p>Had a good experience using our tool? Please share your positive experience with others.</p>
            </div>
          </div>
          <div className="spacer"></div>
        </div>
