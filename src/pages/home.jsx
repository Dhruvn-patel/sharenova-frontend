...
const Home = () => {
  ...
  const sendArrayBuffer = async (arrayBuffer, byteLength) => {
    ...
    const sendChunk = async (chunk) => {
      if (dataChannel.current.bufferedAmount < 16750000) {
        ...
        setTimeout(() => {
          console.log("set time out bufferred : ", dataChannel.current.bufferedAmount);
          sendChunk(chunk);
        }, 500);
      }
    };
  ...
  }, [files, isOpen, sendFiles, dataChannel?.current?.readyState]);
  useEffect(() => {
        ...
        <div className="page-sender">
            ...
            <div className="left">
              {files.length === 0 && (
                <div className="select-files-mobile">
                  <div className="button on-dark" onClick={() => input.current.click()}>
                    Select files
                  </div>
              ...
              <div
                className={`modal-background ${
                  files.length === 0 ? "select-files-desktop" : "container-modal-sender"
                } `}
              ></div>
              <div
                className={`container-modal ${files.length === 0 ? "select-files-desktop" : "container-modal-sender"} `}
              >
                {files.length === 0 && (
                  <div className="transfer-select-files">
                    ...
                    <div
                      ...
                      onDragOver={(e) => {
                        ...
                        e.stopPropagation();
                        e.currentTarget.classList.add("drag-over"); // optional: add a visual effect
                      }}
                      onDragLeave={(e) => {
                        e.preventDefault();
                    ...
                    >
                      ...
                      <span className="drop-them-here">Click to browse or drag files here to start sharing</span>
                    </div>
                  </div>
                )}
                  ...
                  <div className="transfer-sender">
                    <div>
                      <div className="transfer-sender-inner">
                          ...
                          <div className="item-file">
                            <div className="container-name">
                              <span className="filename">
                                {files.length === 1 ? files[0].name : `Multiple Files (${files.length})`}
                              </span>
                            </div>
                        ...
                        <h5>Share Code : {shareCode}</h5>
                        <div className="container-desktop">
                          <div className="container-qr" id="qrcode">
                            <img src={qrCodeImage} alt="QR Code" style={{ height: "125px", width: "125px" }} />
                          </div>
                          <div className="share-buttons w-100">
                            <div
                              className="button-social whatsapp"
                              onClick={() =>
                                window.open(
                                  `https://web.whatsapp.com/send?text=${process.env.REACT_APP_API}/receive/${shareCode}`,
                                  "_blank"
                                )
                              }
                            >
                            ...
                            <div
                              ...
                              onClick={() =>
                                window.open(
                                  `https://www.facebook.com/sharer/sharer.php?mode=message&u=${process.env.REACT_APP_API}/receive/${shareCode}`,
                                  "_blank"
                                )
                              }
                            >
                            ...
                            <div
                              className="button-social email"
                              onClick={() =>
                                window.open(
                                  `mailto:?Subject&body=${process.env.REACT_APP_API}/receive/${shareCode}`,
                                  "_blank"
                                )
                              }
                            >
                            ...
                            <div
                              className="button-social gmail"
                              onClick={() =>
                                window.open(
                                  `https://mail.google.com/mail/?view=cm&source=mailto&body=${process.env.REACT_APP_API}/receive/${shareCode}`,
                                  "_blank"
                                )
                              }
                            >
                            ...
                            <div
                              className="button-social linkdin"
                              onClick={() =>
                                window.open(
                                  `https://www.linkedin.com/sharing/share-offsite/?url=${process.env.REACT_APP_API}/receive/${shareCode}`,
                                  "_blank"
                                )
                              }
                            >
                            ...
                            {/* <div
                              ...
                              onClick={() =>
                                window.open(
                                  `https://www.linkedin.com/sharing/share-offsite/?url=${process.env.REACT_APP_API}/c/H8dC6t8QTRreceive/${shareCode}`,
                                  "_blank"
                                )
                              }
                            >
          ...
          <div className="content-bottom">
            <div className="container-informative">
              <h2>What is ShareNova ?</h2>
              <p className="text-explained">
                We are a free and independent peer-to-peer (P2P) file sharing service that prioritizes your privacy and
                keeps your data safe. We store nothing online: simply close your browser to stop sending. Our mission is
                to make sure people keep their data safely into their own hands, as it should be.
              </p>
              ...
              <div className="item-info">
                ...
                <div className="block-info">
                  ...
                  <p>
                    When you close the browser tab your files are no longer accessible, minimising the risk of anyone
                    getting unwanted access. ShareNova uses the peer-to-peer technology WebRTC to find the shortest
                    path, meaning sometimes your data doesn't even have to leave the building!
                  </p>
                </div>
              </div>
              <div className="item-info">
                ...
                <div className="block-info">
                  ...
                  <p>
                    ...
                    or whatever amount. As long as you keep an eye on your own data usage.
                  </p>
                </div>
              </div>
              <div className="item-info">
                ...
                <div className="block-info">
                  ...
                  <p>
                    Only you and the receiver can access your files. Your data is encrypted end-to-end, and can only be
                    read by your receiver (and you of course). ShareNova currently uses an implementation of{" "}
                    <a className="link" href="https://en.wikipedia.org/wiki/Datagram_Transport_Layer_Security">
                      DTLS 1.3.
                    </a>
                  </p>
                </div>
              ...
              <div className="item-info">
                ...
                <div className="block-info">
                  ...
                  <p>
                    Because we don't store data we don't need bulky servers, and that saves a lot of energy. By using
                    ShareNova you'll have a much smaller carbon footprint than when using a cloud storage provider.
                  </p>
                </div>
              </div>
            </div>
